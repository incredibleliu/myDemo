...
/**
 * Home object for domain model class BatchJobExecutionParams.
 * @see com.david.entity.h2.BatchJobExecutionParams
 * @author Hibernate Tools
 */
public class BatchJobExecutionParamsHome {

	private static final Log log = LogFactory.getLog(BatchJobExecutionParamsHome.class);
	...
	public BatchJobExecutionParams findById(com.david.entity.h2.BatchJobExecutionParamsId id) {
		log.debug("getting BatchJobExecutionParams instance with id: " + id);
		try {
			BatchJobExecutionParams instance = (BatchJobExecutionParams) sessionFactory.getCurrentSession()
					.get("com.david.entity.h2.BatchJobExecutionParams", id);
			if (instance == null) {
	...
	public List findByExample(BatchJobExecutionParams instance) {
		log.debug("finding BatchJobExecutionParams instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.david.entity.h2.BatchJobExecutionParams").add(Example.create(instance)).list();
