...
/**
 * Home object for domain model class BatchStepExecutionContext.
 * @see com.david.entity.h2.BatchStepExecutionContext
 * @author Hibernate Tools
 */
public class BatchStepExecutionContextHome {

	private static final Log log = LogFactory.getLog(BatchStepExecutionContextHome.class);
	...
	public BatchStepExecutionContext findById(long id) {
		...
		try {
			BatchStepExecutionContext instance = (BatchStepExecutionContext) sessionFactory.getCurrentSession()
					.get("com.david.entity.h2.BatchStepExecutionContext", id);
			if (instance == null) {
	...
	public List findByExample(BatchStepExecutionContext instance) {
		log.debug("finding BatchStepExecutionContext instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.david.entity.h2.BatchStepExecutionContext").add(Example.create(instance))
					.list();
